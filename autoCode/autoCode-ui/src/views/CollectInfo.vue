    ...
    <div class="app-container">
        ...
        <el-row>
            <el-col :span="24" class="filter-container">
                    ...
                    <el-input placeholder="假删除 0否 1删过滤" type="number" v-model.number="listQuery.deleteFlg" size="small" class="filter-item" @keyup.enter.native="handleFilter"/>
                    <el-button
                            type="primary"
                            icon="el-icon-search"
                            size="small"
        ...
        <el-row>
            <el-col :span="24">
                <el-table
                    ...
                    <el-table-column label="假删除 0否 1删" show-overflow-tooltip style="width: 10%" align="center">
                        <template slot-scope="scope">
                            {{ scope.row.deleteFlg }}
                        </template>
                    </el-table-column>
...
<script>
    ...
    import HandleDialog from './CollectInfoDialog'
