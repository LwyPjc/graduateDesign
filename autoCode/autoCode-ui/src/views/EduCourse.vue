    ...
    <div class="app-container">
        ...
        <el-row>
            <el-col :span="24" class="filter-container">
                    ...
                    <el-input placeholder="课程编码过滤" v-model="listQuery.code" size="small" class="filter-item" @keyup.enter.native="handleFilter"/>
                    <el-input placeholder="中文名称过滤" v-model="listQuery.name" size="small" class="filter-item" @keyup.enter.native="handleFilter"/>
                    <el-input placeholder="英文名称过滤" v-model="listQuery.nameEng" size="small" class="filter-item" @keyup.enter.native="handleFilter"/>
