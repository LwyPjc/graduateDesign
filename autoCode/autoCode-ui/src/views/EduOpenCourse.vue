    ...
    <div class="app-container">
        ...
        <el-row>
            <el-col :span="24" class="filter-container">
                    ...
                    <el-input placeholder="开课学院过滤" v-model="listQuery.college" size="small" class="filter-item" @keyup.enter.native="handleFilter"/>
                    ...
                    <el-input placeholder="课程id过滤" type="number" v-model.number="listQuery.courseId" size="small" class="filter-item" @keyup.enter.native="handleFilter"/>
                    <el-input placeholder="学分过滤" v-model="listQuery.score" size="small" class="filter-item" @keyup.enter.native="handleFilter"/>
                    <el-input placeholder="学时过滤" type="number" v-model.number="listQuery.hour" size="small" class="filter-item" @keyup.enter.native="handleFilter"/>
                    <el-input placeholder="人数过滤" type="number" v-model.number="listQuery.number" size="small" class="filter-item" @keyup.enter.native="handleFilter"/>
                    <el-input placeholder="开始周过滤" type="number" v-model.number="listQuery.weekStart" size="small" class="filter-item" @keyup.enter.native="handleFilter"/>
                    <el-input placeholder="结束周过滤" type="number" v-model.number="listQuery.weekEnd" size="small" class="filter-item" @keyup.enter.native="handleFilter"/>
                    <el-input placeholder="开始节过滤" type="number" v-model.number="listQuery.nodeStart" size="small" class="filter-item" @keyup.enter.native="handleFilter"/>
                    <el-input placeholder="结束节过滤" type="number" v-model.number="listQuery.nodeEnd" size="small" class="filter-item" @keyup.enter.native="handleFilter"/>
                    ...
                    <el-input placeholder="教室id过滤" type="number" v-model.number="listQuery.classroomId" size="small" class="filter-item" @keyup.enter.native="handleFilter"/>
                    <el-button
                            type="primary"
                            icon="el-icon-search"
                            size="small"
        ...
        <el-row>
            <el-col :span="24">
                <el-table
                    ...
                    <el-table-column label="教室id" show-overflow-tooltip style="width: 10%" align="center">
                        <template slot-scope="scope">
