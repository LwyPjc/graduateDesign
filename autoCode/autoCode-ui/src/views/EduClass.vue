    ...
    <div class="app-container">
        ...
        <el-row>
            <el-col :span="24" class="filter-container">
                    ...
                    <el-input placeholder="专业方向过滤" v-model="listQuery.subjectDir" size="small" class="filter-item" @keyup.enter.native="handleFilter"/>
                    <el-button
                            type="primary"
                            icon="el-icon-search"
                            size="small"
        ...
        <el-row>
            <el-col :span="24">
                <el-table
                    ...
                    <el-table-column label="专业方向" show-overflow-tooltip style="width: 10%" align="center">
                        <template slot-scope="scope">
