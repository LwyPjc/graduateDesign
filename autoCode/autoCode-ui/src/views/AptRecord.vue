        ...
        <el-row>
            <el-col :span="24">
                <el-table
                    ...
                    <el-table-column label="预约科室id" show-overflow-tooltip style="width: 10%" align="center">
                        <template slot-scope="scope">
                            {{ scope.row.dptId }}
                        </template>
                    </el-table-column>
                    <el-table-column label="预约医生id" show-overflow-tooltip style="width: 10%" align="center">
                        <template slot-scope="scope">
                            {{ scope.row.docId }}
                        </template>
                    </el-table-column>
...
<script>
    ...
    import HandleDialog from './AptRecordDialog'
