...
import com.graduation.education.dao.EduOpenCourseDao;
...
@Slf4j
@Service
public class EduOpenCourseServiceImpl extends BaseServiceImpl<EduOpenCourse, EduOpenCourseDao> implements EduOpenCourseService {
