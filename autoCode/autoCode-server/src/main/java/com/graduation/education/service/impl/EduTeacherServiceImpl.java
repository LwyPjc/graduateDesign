...
import com.graduation.education.dao.EduTeacherDao;
...
@Slf4j
@Service
public class EduTeacherServiceImpl extends BaseServiceImpl<EduTeacher, EduTeacherDao> implements EduTeacherService {
