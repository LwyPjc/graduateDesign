  ...
  <div class="app-container">
    ...
    <el-row>
      <el-col :span="24" class="filter-container">
        <el-input placeholder="工号过滤" v-model="listQuery.code" size="small" class="filter-item"
                  @keyup.enter.native="handleFilter"/>
        <el-input placeholder="姓名过滤" v-model="listQuery.name" size="small" class="filter-item"
                  @keyup.enter.native="handleFilter"/>
        <el-button
          type="primary"
          icon="el-icon-search"
    ...
    <el-row>
      <el-col :span="24">
        <el-table
          ...
          <el-table-column label="工号" show-overflow-tooltip style="width: 10%" align="center">
          ...
          <el-table-column label="关联班级" show-overflow-tooltip style="width: 10%" align="center">
            <template slot-scope="scope">
              {{ scope.row.relateClassName}}
            </template>
          </el-table-column>
          <el-table-column
            label="操作"
