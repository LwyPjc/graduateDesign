    ...
    <div class="app-container">
        ...
        <el-row>
            <el-col :span="24" class="filter-container">
                    ...
                    <el-input placeholder="角色 1学生 2辅导员 3教育处过滤" v-model="listQuery.role" size="small" class="filter-item" @keyup.enter.native="handleFilter"/>
                    <el-button
                            type="primary"
                            icon="el-icon-search"
                            size="small"
        ...
        <el-row>
            <el-col :span="24">
                <el-table
                    ...
                    <el-table-column label="角色 1学生 2辅导员 3教育处" show-overflow-tooltip style="width: 10%" align="center">
                        <template slot-scope="scope">
                            {{ scope.row.role }}
                        </template>
                    </el-table-column>
