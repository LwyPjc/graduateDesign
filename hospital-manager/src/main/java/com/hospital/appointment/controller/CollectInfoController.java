...
import com.hospital.appointment.entity.CollectInfo;
import com.hospital.appointment.service.CollectInfoService;
...
public class CollectInfoController {
    ...
    @PostMapping("/save")
    public Serializable save(@RequestBody CollectInfo collectInfo) {
        collectInfo.setCreateTime(getTimestamp());
