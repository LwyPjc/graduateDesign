...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`education` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
insert  into `edu_class`(`ID`,`college`,`grade`,`subject`,`class_no`,`subject_dir`,`counselor_id`) values 
...
/*Data for the table `edu_classroom` */

insert  into `edu_classroom`(`ID`,`name`) values 
(1,'A01');
...
insert  into `edu_course`(`ID`,`college`,`code`,`name`,`name_eng`,`type`) values 
(1,'','c1','C++','C++','1'),
(2,'','c2','Java编程','Java','1'),
(3,'','c3','安卓','Android','0');

/*Table structure for table `edu_open_course` */

DROP TABLE IF EXISTS `edu_open_course`;

CREATE TABLE `edu_open_course` (
  `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
...
/*Data for the table `edu_open_course` */

insert  into `edu_open_course`(`ID`,`term`,`college`,`class_id`,`course_id`,`score`,`hour`,`number`,`week_start`,`week_end`,`week_time`,`node_start`,`node_end`,`teacher_id`,`classroom_id`,`choose_start`,`choose_end`,`choose_num`) values 
...
/*Data for the table `edu_student` */

insert  into `edu_student`(`ID`,`stu_code`,`stu_name`,`stu_name_old`,`stu_name_py`,`sex`,`certificat_type`,`certificate_no`,`nationality`,`hometown`,`nation`,`marriage`,`birthplace`,`birthday`,`political_status`,`phone`,`email`,`qq`,`weChat`,`home_phone`,`home_address`,`postCode`,`skill`,`sickness_history`,`class_id`,`candidate_no`,`admission_time`,`admission_methord`,`stu_status`,`training_level`,`educational_system`,`rewards`,`user_id`) values 
(1,'202101','张三',NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,'在学',NULL,NULL,NULL,NULL),
(2,'202102','李四',NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,4,NULL,NULL,NULL,'在学',NULL,NULL,NULL,NULL),
(3,'202103','李丽',NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,2,NULL,NULL,NULL,'在学',NULL,NULL,NULL,NULL);
...
insert  into `edu_teacher`(`ID`,`code`,`name`,`relate_class_ids`) values 
(1,'t01','教师1','1,2'),
(3,'t02','王玲','4');
...
CREATE TABLE `sys_user` (
  ...
  `role` varchar(32) DEFAULT NULL COMMENT '角色 1学生 2教师 3管理员',
  PRIMARY KEY (`ID`),
