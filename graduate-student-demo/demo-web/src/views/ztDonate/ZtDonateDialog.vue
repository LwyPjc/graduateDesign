...
<!-- 编辑弹窗 -->
  <el-dialog
    ...
    <el-form :model="dialogFormData"
        ...
        <el-form-item label="捐赠金额" label-width="105px" prop="donatePrice">
            <el-input placeholder="请输入捐赠金额" v-model="dialogFormData.donatePrice"/>
        </el-form-item>
        <el-form-item label="捐赠时间" label-width="105px" prop="donateTime">
            <el-date-picker
                v-model="dialogFormData.donateTime"
                type="date"
                placeholder="选择捐赠时间">
            </el-date-picker>
        </el-form-item>
