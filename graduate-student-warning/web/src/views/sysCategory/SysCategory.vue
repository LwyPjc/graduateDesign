    ...
    <div class="app-container">
        ...
        <el-row>
            <el-col :span="24" class="filter-container">
                    <el-input placeholder="类别名称过滤" v-model="listQuery.name" size="small" class="filter-item" @keyup.enter.native="handleFilter"/>
                    <el-button
                            type="primary"
                            icon="el-icon-search"
                            size="small"
        ...
        <el-row>
            <el-col :span="24">
                <el-table
                    ...
                    <el-table-column label="类别名称" show-overflow-tooltip style="width: 10%" align="center">
                        <template slot-scope="scope">
                            {{ scope.row.name }}
                        </template>
                    </el-table-column>
...
<script>
    ...
    import HandleDialog from './SysCategoryDialog'
    ...
    export default {
        ...
        data() {
            return {
                ...
                prefixUrl: this.GLOBAL.baseUrl + '/sysCategory'
            }
        },
        created() {
            this.fetchData()
